...
*/
func newCardWithCtx(ctx *C.vssc_card_t /*ct2*/) *Card {
    obj := &Card {
        cCtx: ctx,
    }
    runtime.SetFinalizer(obj, (*Card).Delete)
...
* Note. This method is used in generated code only, and SHOULD NOT be used in another way.
*/
func newCardCopy(ctx *C.vssc_card_t /*ct2*/) *Card {
    obj := &Card {
...
func (obj *Card) PublicKey() (foundation.PublicKey, error) {
    ...
    return foundation.FoundationImplementationWrapPublicKeyCopy(proxyResult) /* r4.1 */
}
