...
import "runtime"
import foundation "github.com/VirgilSecurity/virgil-commkit-go/crypto/wrapper/foundation"
...
*/
func newKeyHandlerWithCtx(ctx *C.vssc_key_handler_t /*ct2*/) *KeyHandler {
    obj := &KeyHandler {
        cCtx: ctx,
    }
    runtime.SetFinalizer(obj, (*KeyHandler).Delete)
...
* Note. This method is used in generated code only, and SHOULD NOT be used in another way.
*/
func newKeyHandlerCopy(ctx *C.vssc_key_handler_t /*ct2*/) *KeyHandler {
    obj := &KeyHandler {
...
func (obj *KeyHandler) Key() (foundation.Key, error) {
    ...
    return foundation.FoundationImplementationWrapKeyCopy(proxyResult) /* r4.1 */
}
