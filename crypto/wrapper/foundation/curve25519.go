 ...
 */
func NewCurve25519WithCtx(pointer unsafe.Pointer) *Curve25519 {
	ctx := (*C.vscf_curve25519_t /*ct10*/)(pointer)
	obj := &Curve25519{
		cCtx: ctx,
	}
	runtime.SetFinalizer(obj, (*Curve25519).Delete)
...
* Note. This method is used in generated code only, and SHOULD NOT be used in another way.
 */
func NewCurve25519Copy(pointer unsafe.Pointer) *Curve25519 {
	ctx := (*C.vscf_curve25519_t /*ct10*/)(pointer)
	obj := &Curve25519{
